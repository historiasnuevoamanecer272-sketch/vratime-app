...
export default function ContactChannelsFields({ contacts, onChange, t }) {
  ...
  // A single space keeps an empty phone channel selected until its owner types a number.
  // It is trimmed out before validation and persistence.
    ...
    <fieldset className="contact-channels">
      ...
      <div className="mt-3 space-y-3">
        {contactChannels.map((channel) => {
          const active = contacts[channel.id] !== '';
