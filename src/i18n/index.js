  ...
  ru: {
    translation: {
      ...
      map: {
        ...
        listTitle: 'Рядом с вами', expand: 'Показать список', collapse: 'Свернуть список', refresh: 'Обновить', resetFilters: 'Сбросить фильтры',
      },
      create: {
