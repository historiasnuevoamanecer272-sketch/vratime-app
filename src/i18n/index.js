...
export const resources = {
  ru: {
    translation: {
      ...
      deals: {
        ...
        complete: 'Передача состоялась', completing: 'Завершаем…', cancel: 'Отменить бронь', canceling: 'Отменяем…', cancelConfirm: 'Отменить бронь? Объявление снова станет доступно на карте.',
        completed: 'Сделка завершена. Начислено 50 экобаллов.', canceled: 'Бронь отменена, история сохранена.',
        rate: 'Оценить партнёра', ratingSent: 'Спасибо! Отзыв сохранён.', details: 'Детали сделки', flowLabel: 'Ход сделки', flowReserved: 'Бронь', flowContact: 'Связь', flowHandover: 'Передача',
      },
      profile: {
        ...
        pointsEarn: 'За каждую завершённую передачу даритель получает 50 баллов.', pointsLevels: 'Баллы открывают новые уровни и достижения в профиле.',
  ...
  me: {
    translation: {
      ...
      deals: { eyebrow: 'Dogovori', title: 'Moje razmjene', giving: 'Poklanjam', taking: 'Preuzimam', active: 'Aktivno', history: 'Istorija', emptyTitle: 'Još nema dogovora', emptyText: 'Rezervišite oglas na mapi i pojaviće se ovdje.', contact: 'Kontakt partnera', contactHidden: 'Kontakt je dostupan samo učesnicima potvrđenog dogovora.', complete: 'Predaja je završena', completing: 'Završavamo…', cancel: 'Otkaži rezervaciju', canceling: 'Otkazujemo…', cancelConfirm: 'Otkaži rezervaciju? Oglas će ponovo biti dostupan na mapi.', completed: 'Dogovor je završen. Dodato je 50 eko bodova.', canceled: 'Rezervacija je otkazana, istorija je sačuvana.', rate: 'Ocijeni partnera', ratingSent: 'Hvala! Ocjena je sačuvana.', details: 'Detalji dogovora', flowLabel: 'Tok dogovora', flowReserved: 'Rezervacija', flowContact: 'Kontakt', flowHandover: 'Predaja' },
      profile: { eyebrow: 'Vaš doprinos', ecoPoints: 'Eko bodovi', rating: 'Ocjena', deals: 'Dogovora', items: 'Jedinica vraćeno', level: 'Nivo', nextLevel: 'Do sljedećeg nivoa — {{count}} bodova', maxLevel: 'Najviši nivo', levels: ['Eko početnik', 'Eko prijatelj', 'Eko aktivista', 'Eko heroj', 'Eko ambasador'], pointsWhy: 'Čemu služe eko bodovi?', pointsIntro: 'Oni jasno pokazuju vaš doprinos ponovnoj upotrebi stvari i materijala.', pointsEarn: 'Poklonodavac dobija 50 bodova za svaku završenu predaju.', pointsLevels: 'Bodovi otključavaju nove nivoe i dostignuća u profilu.', pointsNoMoney: 'Za sada su reputacija unutar VratiMe, a ne novac ili popust.', edit: 'Uredi profil', name: 'Ime', language: 'Jezik', messenger: 'Aplikacija', contact: 'Kontakt', achievements: 'Nagrade', firstDeal: 'Prvi dogovor', fiveDeals: '5 dogovora', fiftyItems: '50 jedinica', topRating: 'Visoka ocjena', listings: 'Moji oglasi', noListings: 'Ovdje će biti vaši aktivni oglasi.', deactivate: 'Ukloni oglas', deactivateConfirm: 'Ukloniti oglas? Nestaće sa mape.', reviews: 'Posljednje ocjene', noReviews: 'Još nema ocjena.', logout: 'Odjavi se', saved: 'Profil je ažuriran.' },
