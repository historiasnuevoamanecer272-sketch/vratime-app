...
export const resources = {
  ru: {
    translation: {
      ...
      support: {
        title: 'Поддержать приложение', text: 'Поддержите работу и развитие VratiMe. Наша ежемесячная цель — {{amount}}.',
        monthGoal: 'Этот месяц', yearGoal: '{{year}} год', of: 'из', action: 'Поддержать VratiMe', soon: 'Подключаем оплату',
        reserve: 'В резерве {{amount}} — ещё примерно {{count}} мес.', supporters: 'Поддержали: {{count}}', updated: 'Обновлено {{date}}', empty: 'Поступлений пока нет',
        netNote: 'Шкалы показывают сумму после комиссии платёжного сервиса. Донаты не влияют на экобаллы и рейтинг.',
      },
  ...
  me: {
    translation: {
      ...
      support: { title: 'Podržite aplikaciju', text: 'Podržite rad i razvoj VratiMe. Naš mjesečni cilj je {{amount}}.', monthGoal: 'Ovaj mjesec', yearGoal: '{{year}}. godina', of: 'od', action: 'Podrži VratiMe', soon: 'Povezujemo plaćanje', reserve: 'U rezervi je {{amount}} — još približno {{count}} mj.', supporters: 'Podržali: {{count}}', updated: 'Ažurirano {{date}}', empty: 'Još nema uplata', netNote: 'Trake prikazuju iznos poslije provizije servisa za plaćanje. Donacije ne utiču na eko bodove ni rang.' },
  ...
  en: {
    translation: {
      ...
      support: { title: 'Support the app', text: 'Support the operation and development of VratiMe. Our monthly goal is {{amount}}.', monthGoal: 'This month', yearGoal: '{{year}}', of: 'of', action: 'Support VratiMe', soon: 'Payments coming soon', reserve: '{{amount}} in reserve — about {{count}} more months', supporters: 'Supporters: {{count}}', updated: 'Updated {{date}}', empty: 'No contributions yet', netNote: 'Progress shows the amount after payment-service fees. Donations do not affect eco points or ranking.' },
