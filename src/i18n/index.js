  ...
  ru: {
    translation: {
      ...
      map: {
        ...
        offers: '{{count}} объявлений', mine: 'Моих: {{count}}', give: 'Отдают', take: 'Ищут', quantity: 'Количество',
        ...
        listTitle: 'Рядом с вами', expand: 'Показать список', collapse: 'Свернуть список', refresh: 'Обновить',
      },
      create: {
...
const storedLanguage = window.localStorage.getItem('vratimeLanguage');
...
i18n.on('languageChanged', (language) => {
  ...
  window.localStorage.setItem('vratimeLanguage', normalized);
  document.documentElement.lang = normalized === 'me' ? 'sr-Latn-ME' : normalized;
});

document.documentElement.lang = initialLanguage === 'me' ? 'sr-Latn-ME' : initialLanguage;
